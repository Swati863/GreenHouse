...
import { Stack,Box, Button ,Text ,Image} from '@chakra-ui/react'
import Navbar from '../Components/Navbar'

const Greenhouse = () => {
  return (
    
    <div style={{padding:"0px 40px 0px 100px"}}>
     ...
     <Box  w='50%' padding="80px" borderRight={"solid"}>
        ...
        <Button  iconSpacing="2rem" colorScheme='green' borderRadius={50} fontFamily={"Untitled Sans"} fontSize={'18px'} padding="25px" >Share Your thoughts on G2</Button>
       </Box>
